...
//			chart.setChartType(ChartShape.Column);
            ...
            //set Pie 1's color to red
            ChartFormat cf = chart.getDataPointFormat(0, 0);
            cf.setSolid();
            cf.setForeColor(Color.RED.getRGB());
            chart.setDataPointFormat(0, 0, cf);
