...
public class InterfaceCuisinier extends JFrame {
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				InterfaceCuisinier thisClass = new InterfaceCuisinier(entreeValide);
	 ...
	 */
	public InterfaceCuisinier(String entreeIdentifiant) {
		super();
		entreeValide = entreeIdentifiant;
		System.out.println("Interface Cuisinier, identifiant : "+entreeValide);
		initialize();
	}
