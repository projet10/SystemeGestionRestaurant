...
public class InterfaceGerant extends JFrame {
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				InterfaceGerant thisClass = new InterfaceGerant(entreeValide);
	 ...
	 */
	public InterfaceGerant(String entreeIdentifiant) {
		super();
		entreeValide = entreeIdentifiant;
		System.out.println("Interface Gerant, identifiant : "+entreeValide);
		initialize();
	}
